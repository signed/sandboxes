...
public class ServletRequestForTest implements HttpServletRequest {
    private final String content;
    private String pathInfo;

    public ServletRequestForTest(String content) {
    ...
    public ServletInputStream getInputStream() throws IOException {
        ...
        return new ServletInputStream() {
            ...
            public int read() throws IOException {
                return theContent.read();
            }

            @Override
            public boolean isFinished() {
                throw new RuntimeException("isFinished not implemented");
            }
            ...
            public void setReadListener(ReadListener readListener) {
                throw new RuntimeException("setReadListener not implemented");
            }
        };
    }
