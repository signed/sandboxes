...
public class DelayEchoServiceClient {
    public Observable<ResponseEntity<EchoTransferObject>> callWith(Delay delay, Message message) {
        ...
        ListenableFuture<ResponseEntity<EchoTransferObject>> first = rest.postForEntity("http://localhost:9000/", echoTransferObject(delay, message), EchoTransferObject.class);
